        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?=$_foto_logado?>" class="user-image" style="border-radius:50%;width:25px;height:25px;object-fit:cover;" alt="Foto">
              <span class="hidden-xs">{{ utf8_decode(Session::get('login.ponto.painel.usuario_nome')) }}</span>
            </a>
            <ul class="dropdown-menu">
              <!-- The user image in the menu -->
              <li class="user-header">
                <img src="<?=$_foto_logado?>" class="img-circle" alt="User Image">
