            ...
            <div class="box-body table-responsive">
              <table id="example1" class="table table-bordered table-striped">
                ...
                @foreach($usuarios as $usuario)
                    <tr>
                      <td>
                          <?php $foto_u = $usuario->foto ? getenv('APP_URL').'/img/foto/'.$usuario->foto : getenv('APP_URL').'/img/avatar.png'; ?>
                          <img src="<?=$foto_u?>" style="width:38px;height:38px;object-fit:cover;border-radius:50%;border:1px solid #ccc;" alt="">
                      </td>
