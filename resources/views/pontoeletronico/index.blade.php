...
<div class="login-box">
  <div class="login-logo">
      <a href="#"><img src="{{ getenv('APP_URL') }}/img/ilab4_logo_pontoeletronico.png" style="max-width: 100%; width: 350px; height: auto;"></a>
  ...
  <div class="login-box-body">
    ...
    <div style="margin-top: 20px; text-align: center;">
        <a href="http://163.176.252.24:8080/painel/" class="btn btn-default btn-block">
            <i class="fa fa-sign-in"></i> Acesso Painel Colaborador
        </a>
    </div>
