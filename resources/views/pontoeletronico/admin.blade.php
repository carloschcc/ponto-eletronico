...
$_usuario_registro = App\Usuario::find(Session::get('login.ponto.usuario_id'));
$_foto_registro    = ($_usuario_registro && $_usuario_registro->foto)
    ? $url_base . '/img/foto/' . $_usuario_registro->foto
    : $url_base . '/img/avatar.png';
?>
<!DOCTYPE html>
<html>
<head>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?=$_foto_registro?>" class="user-image" style="border-radius:50%;width:25px;height:25px;object-fit:cover;" alt="Foto">
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        <div class="pull-left image">
          <img src="<?=$_foto_registro?>" class="img-circle" alt="User Image">
        </div>
